...
namespace Mnk.TBox.Plugins.Market.Client.ServiceReference {
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Runtime.Serialization", "4.0.0.0")]
    [System.Runtime.Serialization.DataContractAttribute(Name="PairOfstringint", Namespace="http://schemas.datacontract.org/2004/07/Common.Data")]
    [System.SerializableAttribute()]
    public partial class PairOfstringint : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
    ...
    public interface IMarketService {
        ...
        Mnk.TBox.Plugins.Market.Client.ServiceReference.Plugin[] Plugin_GetList(Mnk.TBox.Plugins.Market.Client.ServiceReference.Plugin filter, int offset, int count, System.Nullable<bool> onlyPlugins);
        ...
        int Plugin_GetListCount(Mnk.TBox.Plugins.Market.Client.ServiceReference.Plugin filter);
        ...
        Mnk.TBox.Plugins.Market.Client.ServiceReference.DataContract Plugin_Download(Mnk.TBox.Plugins.Market.Client.ServiceReference.DownloadContract request);
        ...
        Mnk.TBox.Plugins.Market.Client.ServiceReference.UploadContract Plugin_Upload(Mnk.TBox.Plugins.Market.Client.ServiceReference.PluginUploadContract request);
        ...
        Mnk.TBox.Plugins.Market.Client.ServiceReference.UploadContract Plugin_Upgrade(Mnk.TBox.Plugins.Market.Client.ServiceReference.PluginUploadContract request);
        ...
        bool Plugin_Delete(Mnk.TBox.Plugins.Market.Client.ServiceReference.Plugin plugin);
        ...
        bool Plugin_Exist(Mnk.TBox.Plugins.Market.Client.ServiceReference.Plugin plugin);
        ...
        Mnk.TBox.Plugins.Market.Client.ServiceReference.Bug[] Bug_GetList(long uid, int offset, int count);
        ...
        void Bug_Send(Mnk.TBox.Plugins.Market.Client.ServiceReference.Bug bug);
    ...
    public partial class DataContract {
        ...
        public DataContract(Pair<string,int>[] Descriptions, long Length, System.IO.Stream FileByteStream) {
    ...
    public partial class PluginUploadContract {
        ...
        [System.ServiceModel.MessageHeaderAttribute(Namespace="http://tempuri.org/")]
        public Mnk.TBox.Plugins.Market.Client.ServiceReference.Plugin Item;
        ...
        public PluginUploadContract(Pair<string, int>[] Descriptions, Mnk.TBox.Plugins.Market.Client.ServiceReference.Plugin Item, long Length, System.IO.Stream FileByteStream)
        {
            this.Descriptions = Descriptions;
            this.Item = Item;
            this.Length = Length;
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IMarketServiceChannel : Mnk.TBox.Plugins.Market.Client.ServiceReference.IMarketService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class MarketServiceClient : System.ServiceModel.ClientBase<Mnk.TBox.Plugins.Market.Client.ServiceReference.IMarketService>, Mnk.TBox.Plugins.Market.Client.ServiceReference.IMarketService {
        ...
        public Mnk.TBox.Plugins.Market.Client.ServiceReference.Plugin[] Plugin_GetList(Mnk.TBox.Plugins.Market.Client.ServiceReference.Plugin filter, int offset, int count, System.Nullable<bool> onlyPlugins) {
            return base.Channel.Plugin_GetList(filter, offset, count, onlyPlugins);
        }
        
        public int Plugin_GetListCount(Mnk.TBox.Plugins.Market.Client.ServiceReference.Plugin filter) {
            return base.Channel.Plugin_GetListCount(filter);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        Mnk.TBox.Plugins.Market.Client.ServiceReference.DataContract Mnk.TBox.Plugins.Market.Client.ServiceReference.IMarketService.Plugin_Download(Mnk.TBox.Plugins.Market.Client.ServiceReference.DownloadContract request) {
            return base.Channel.Plugin_Download(request);
        }

        public Pair<string, int>[] Plugin_Download(string Author, string Name, out long Length, out System.IO.Stream FileByteStream)
        {
            Mnk.TBox.Plugins.Market.Client.ServiceReference.DownloadContract inValue = new Mnk.TBox.Plugins.Market.Client.ServiceReference.DownloadContract();
            inValue.Author = Author;
            inValue.Name = Name;
            Mnk.TBox.Plugins.Market.Client.ServiceReference.DataContract retVal = ((Mnk.TBox.Plugins.Market.Client.ServiceReference.IMarketService)(this)).Plugin_Download(inValue);
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        Mnk.TBox.Plugins.Market.Client.ServiceReference.UploadContract Mnk.TBox.Plugins.Market.Client.ServiceReference.IMarketService.Plugin_Upload(Mnk.TBox.Plugins.Market.Client.ServiceReference.PluginUploadContract request) {
            return base.Channel.Plugin_Upload(request);
        }

        public bool Plugin_Upload(Pair<string, int>[] Descriptions, Mnk.TBox.Plugins.Market.Client.ServiceReference.Plugin Item, long Length, System.IO.Stream FileByteStream, out bool Success)
        {
            Mnk.TBox.Plugins.Market.Client.ServiceReference.PluginUploadContract inValue = new Mnk.TBox.Plugins.Market.Client.ServiceReference.PluginUploadContract();
            inValue.Descriptions = Descriptions;
            inValue.Item = Item;
            inValue.Length = Length;
            inValue.FileByteStream = FileByteStream;
            Mnk.TBox.Plugins.Market.Client.ServiceReference.UploadContract retVal = ((Mnk.TBox.Plugins.Market.Client.ServiceReference.IMarketService)(this)).Plugin_Upload(inValue);
            Success = retVal.Success;
            return retVal.Exist;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        Mnk.TBox.Plugins.Market.Client.ServiceReference.UploadContract Mnk.TBox.Plugins.Market.Client.ServiceReference.IMarketService.Plugin_Upgrade(Mnk.TBox.Plugins.Market.Client.ServiceReference.PluginUploadContract request) {
            return base.Channel.Plugin_Upgrade(request);
        }

        public bool Plugin_Upgrade(Pair<string, int>[] Descriptions, Mnk.TBox.Plugins.Market.Client.ServiceReference.Plugin Item, long Length, System.IO.Stream FileByteStream, out bool Success)
        {
            Mnk.TBox.Plugins.Market.Client.ServiceReference.PluginUploadContract inValue = new Mnk.TBox.Plugins.Market.Client.ServiceReference.PluginUploadContract();
            inValue.Descriptions = Descriptions;
            inValue.Item = Item;
            inValue.Length = Length;
            inValue.FileByteStream = FileByteStream;
            Mnk.TBox.Plugins.Market.Client.ServiceReference.UploadContract retVal = ((Mnk.TBox.Plugins.Market.Client.ServiceReference.IMarketService)(this)).Plugin_Upgrade(inValue);
            Success = retVal.Success;
            return retVal.Exist;
        }
        
        public bool Plugin_Delete(Mnk.TBox.Plugins.Market.Client.ServiceReference.Plugin plugin) {
            return base.Channel.Plugin_Delete(plugin);
        }
        
        public bool Plugin_Exist(Mnk.TBox.Plugins.Market.Client.ServiceReference.Plugin plugin) {
            return base.Channel.Plugin_Exist(plugin);
        }
        
        public Mnk.TBox.Plugins.Market.Client.ServiceReference.Bug[] Bug_GetList(long uid, int offset, int count) {
        ...
        public void Bug_Send(Mnk.TBox.Plugins.Market.Client.ServiceReference.Bug bug) {
