    ...
    class Program
    {
        ...
        static int Main(string[] args)
        {
            ...
            try
            {
                ...
                return testsRunner.Run(cmdArgs.Path, cmdArgs.ProcessCount, cmdArgs.X86, cmdArgs.Clone, cmdArgs.CopyMasks, cmdArgs.Sync, cmdArgs.Report, cmdArgs.DirToCloneTests, cmdArgs.CommandBeforeTestsRun, cmdArgs.Include, cmdArgs.Exclude, cmdArgs.StartDelay);
            }
            catch (Exception ex)
            {
